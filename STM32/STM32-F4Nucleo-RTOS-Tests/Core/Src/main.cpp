...
/* Definitions for testSmartSerial */
...
int main(void)
{
  ...
  /* creation of testSmartSerial */
  testSmartSerialHandle = osThreadNew(startTests, NULL, &testSmartSerial_attributes);
...
/* USER CODE BEGIN Header_startTests */
/**
* @brief Function implementing the testSmartSerial thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_startTests */
void startTests(void *argument)
{
